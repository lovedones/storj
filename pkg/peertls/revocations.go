...
var RevocationCheckExtensionHandler = &GenericExtensionHandler{
	oid:         &RevocationExtID,
	newVerifier: revocationChecker,
}
...
var ErrRevocationTimestamp = ErrExtension.New("revocation timestamp is older than last known revocation")
...
func revocationChecker(opts ExtensionOptions) ExtensionVerificationFunc {
...
func revocationUpdater(opts ExtensionOptions) ExtensionVerificationFunc {
...
var RevocationUpdateExtensionHandler = &GenericExtensionHandler{
	oid:         &RevocationExtID,
	newVerifier: revocationUpdater,
}
