...
func (m *lockedStatDB) Create(ctx context.Context, nodeID storj.NodeID, initial *statdb.NodeStats) (stats *statdb.NodeStats, err error) {
	m.Lock()
	fmt.Printf("lockedStatDB Create locked")
	debug.PrintStack()
	defer fmt.Printf("lockedStatDB Create unlocked")
	defer m.Unlock()
...
func (m *lockedStatDB) CreateEntryIfNotExists(ctx context.Context, nodeID storj.NodeID) (stats *statdb.NodeStats, err error) {
	m.Lock()
	fmt.Printf("lockedStatDB CreateEntryIfNotExists locked")
	debug.PrintStack()
	defer fmt.Printf("lockedStatDB CreateEntryIfNotExists unlocked")
	defer m.Unlock()
...
func (m *lockedStatDB) FindInvalidNodes(ctx context.Context, nodeIDs storj.NodeIDList, maxStats *statdb.NodeStats) (invalid storj.NodeIDList, err error) {
	m.Lock()
	fmt.Printf("lockedStatDB FindInvalidNodes locked")
	debug.PrintStack()
	defer fmt.Printf("lockedStatDB FindInValidNodes unlocked")
	defer m.Unlock()
...
func (m *lockedStatDB) Get(ctx context.Context, nodeID storj.NodeID) (stats *statdb.NodeStats, err error) {
	m.Lock()
	fmt.Printf("lockedStatDB Get locked")
	debug.PrintStack()
	defer fmt.Printf("lockedStatDB Get unlocked")
	defer m.Unlock()
	return m.db.Get(ctx, nodeID)
}
...
func (m *lockedStatDB) Update(ctx context.Context, request *statdb.UpdateRequest) (stats *statdb.NodeStats, err error) {
	m.Lock()
	fmt.Printf("lockedStatDB Update locked")
	debug.PrintStack()
	defer fmt.Printf("lockedStatDB Update unlocked")
	defer m.Unlock()
...
func (m *lockedStatDB) UpdateAuditSuccess(ctx context.Context, nodeID storj.NodeID, auditSuccess bool) (stats *statdb.NodeStats, err error) {
	m.Lock()
	fmt.Printf("lockedStatDB UpdateAuditSuccess locked")
	debug.PrintStack()
	defer fmt.Printf("lockedStatDB UpdateAuditSuccess unlocked")
	defer m.Unlock()
...
func (m *lockedStatDB) UpdateBatch(ctx context.Context, requests []*statdb.UpdateRequest) (statslist []*statdb.NodeStats, failed []*statdb.UpdateRequest, err error) {
	m.Lock()
	fmt.Printf("lockedStatDB UpdateBatch locked")
	debug.PrintStack()
	defer fmt.Printf("lockedStatDB UpdateBatch unlocked")
	defer m.Unlock()
...
func (m *lockedStatDB) UpdateUptime(ctx context.Context, nodeID storj.NodeID, isUp bool) (stats *statdb.NodeStats, err error) {
	m.Lock()
	fmt.Printf("lockedStatDB UpdateUptime locked")
	debug.PrintStack()
	defer fmt.Printf("lockedStatDB UpdateUptime unlocked")
	defer m.Unlock()
